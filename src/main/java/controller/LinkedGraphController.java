...
public class LinkedGraphController {
    ...
    public void initialize() {
        ...
        infoLabel.setText("Lista Enlazada - Personajes históricos");
    ...
    private void loadInitialGraph() {
        try {
            ...
            visualizeGraph();
            updateTextArea("Grafo inicial cargado con personajes históricos.");
    ...
    public void randomizeOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            visualizeGraph();
            updateTextArea("Grafo aleatorizado con personajes históricos.");
    ...
    private void visualizeGraph() {
        ...
        try {
            ...
            infoLabel.setText("Grafo visualizado con " + vertices.size() + " personajes.");
